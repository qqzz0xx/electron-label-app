...
export class MPRView extends baseView {
  ...
  updateSlicePlane(viewData) {
    ...
    mat4.rotate(planeMat, planeMat, degrees2radians(viewData.slicePlaneYRotation), sliceYRotVector)
    mat4.rotate(planeMat, planeMat, degrees2radians(viewData.slicePlaneXRotation), sliceXRotVector)

    if (this.VERBOSE) console.log(cachedSlicePlane, viewData.slicePlaneNormal, planeMat)
    ...
    quat.setAxisAngle(viewRotQuat, cachedSlicePlane, degrees2radians(-viewData.viewRotation))
    quat.normalize(viewRotQuat, viewRotQuat)

    // rotate the ViewUp with the x and z rotations
    const xQuat = quat.create()
    quat.setAxisAngle(xQuat, sliceXRotVector, degrees2radians(viewData.slicePlaneXRotation))
